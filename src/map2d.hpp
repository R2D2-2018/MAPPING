...
namespace Mapping
{
	...
	public:
         ...
         * 
		 * @param [Vectr2d] sensorPosition - The position of the 
         ...
         * @brief Moves the sensor with the given delta.
		 * 
		 * @param [Angle] angle - The angle in which the position
		 * is changed. Angle 0 is pointing downwards, and
		 * grows counterclockwise.
		 * 
		 * @param [double] distance - The distance delta
		 ...
		 * impassable.
		 * 
		 * @param [Angle] angle - The angle in which in the direction
		 * of the to bet set point. Angle 0 is pointing downwards, and
		 * grows counterclockwise.
		 *
		 *  @param [double] distance - The distance of the point to the
		 * 
		 * NOTE: This value is given in cm, not in grid points!
         */
